...
public final class FirstServiceDescriptor implements ServiceDescriptor {
    ...
    public FirstServiceDescriptor() {}

    @Override
    public String dockerImage() {
        return "ghcr.io/creek-service/basic-kafka-streams-demo-first-service";
    }
