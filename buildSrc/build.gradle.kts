...
dependencies {
    ...
    implementation("com.diffplug.spotless:spotless-plugin-gradle:6.14.0")                   // https://plugins.gradle.org/plugin/com.diffplug.spotless
    ...
    implementation("org.creekservice:creek-system-test-gradle-plugin:0.3.0")                // https://plugins.gradle.org/plugin/org.creekservice.system.test
}